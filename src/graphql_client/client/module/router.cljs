(ns graphql-client.client.module.router
...
(defmethod ig/init-key :graphql-client.client.module/router
  [k {:keys [:routes]}]
...
(defmethod ig/halt-key! :graphql-client.client.module/router
